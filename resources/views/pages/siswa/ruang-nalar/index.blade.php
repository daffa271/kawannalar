        ...
        <section class="rounded-2xl border border-gray-100 bg-white p-3.5 sm:p-5 shadow-sm space-y-3 sm:space-y-4 min-w-0 overflow-hidden">
            <form method="GET" action="{{ route('siswa.ruang-nalar.index') }}" class="space-y-3 sm:space-y-4">
                ...
                <div class="flex items-center gap-1.5 overflow-x-auto pb-1 text-xs whitespace-nowrap max-w-full scrollbar-none">
                    ...
                    $presetMapel = ['Matematika', 'Biologi', 'Fisika', 'Kimia', 'UTBK', 'Bahasa Indonesia', 'Bahasa Inggris'];
                    @endphp
            ...
            <div @click.outside="uploadOpen = false"
                ...
                <form method="POST" action="{{ route('siswa.ruang-nalar.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid gap-3 sm:grid-cols-2">
                        <div>
                            ...
                            <select id="modal-subject" name="subject" required
                                ...
                                @foreach (['Matematika', 'Kimia', 'Fisika', 'Biologi', 'Bahasa Indonesia', 'Bahasa Inggris', 'UTBK', 'Lainnya'] as $subject)
                    ...
                    <div>
                        ...
                        <div class="relative rounded-2xl border-2 border-dashed bg-gray-50/60 p-4 sm:p-5 text-center transition"
                            :class="fileTooLarge ? 'border-red-400 bg-red-50/60' : 'border-gray-200 hover:border-[#0A52C4]'">
                            ...
                            <template x-if="fileName">
                                <div>
                                    <span class="text-2xl sm:text-3xl" x-text="fileTooLarge ? '⚠️' : '✅'"></span>
                                    <p class="mt-1.5 break-all text-xs font-bold" :class="fileTooLarge ? 'text-red-700' : 'text-emerald-700'" x-text="fileName"></p>
                                    <p class="mt-0.5 text-[10px]" :class="fileTooLarge ? 'text-red-600 font-bold' : 'text-gray-500'"
                    ...
                    <div class="flex justify-end gap-2 border-t border-gray-100 pt-3.5 mt-2">
                        ...
                        <button type="submit" :disabled="fileTooLarge"
                            :class="fileTooLarge ? 'cursor-not-allowed bg-gray-300 shadow-none' : 'bg-[#FF7A00] hover:bg-[#E06C00] shadow-sm'"
                            class="rounded-xl px-4 sm:px-5 py-2 font-extrabold text-white transition">
